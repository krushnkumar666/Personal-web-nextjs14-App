  ...
  return (
    <main className="w-screen h-screen relative">
      ...
      Make anything possible with 
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-red-500"> Web Development
        </span>
      </h1>
      <p className="text-gray-200 hidden md:block">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium fugiat possimus ipsum voluptates impedit fugit iste quidem  odit enim amet corrupti?</p>
      <div className="flex-col md:flex-row hidden md:flex gap-5">
        ...
        <Link href="/my-contact-me" className="rounded-[20px] group relative bg-transparent border border-white hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px]">
        <div className="absolute rounded-[20px] z-[1] bg-white inset-0 opacity-0 group-hover:opacity-10"/>
        contact me
        </Link>
      </div>
      ...
      <div className="absolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5">
        ...
        <Link href="/my-contact-me" className="rounded-[20px] group bg-transparent border border-white px-5 py-3 text-lg text-white max-w-[200px]">
